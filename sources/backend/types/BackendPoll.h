...
struct BackendPollMetadata {
	...
	bool						allowsPublicAddOption = false;
...
public:
	...
	/** Refresh post-backed poll fields without replacing this QObject or metadata. */
	void updateDefinition (const BackendPoll& other);
signals:
